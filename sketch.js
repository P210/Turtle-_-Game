...
function preload(){
  ...
  diesound = loadSound("Touch_sound.mp3")
  clicksound = loadSound("Click_sound.mp3");
  watersound = loadSound("water.mp3");
  introduction_img = loadImage("turtle_img.jpg");
...
function draw(){
  ...
  background(introduction_img,400,400);
...
//Intro message of the game
  ...
  if(World.frameCount<200 ){
    ...
    text("Welcome to Turtle Saver Game !", 100,200);
    text("Control Turtle with your arrow keys",100,300);
    text("Help the turtle from plastic trash ", 100,400);
...
gameState = "end"
    ...
    if(gameState=== "end"){
      ...
      cocacolaGroup.setVelocityYEach(0);
      bg.velocityX = 0;
      score=0;
      play.visible = true;
      spawnMessage1();
